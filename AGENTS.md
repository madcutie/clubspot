...
| [`docs/research-salida-a-produccion.md`](docs/research-salida-a-produccion.md) | **Relevamiento de salida a producción** (20/08/2026): qué separa al repo de un club real usándolo. Los datos del club ya son del tenant, pero **no hay forma de crear un club ni un usuario en producción**, no hay imágenes ni migraciones desplegadas, y el cliente que reserva no recibe ningún aviso. Incluye las 9 decisiones que bloquean y un orden por dependencia |
